...
function addArchive(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const { service, name, numberOrder, brand, model, numberSerie, numberInventory, start, end, observations, materials, departureDestination, inCharge, tecnicInCharge } = req.body;
